"use strict";
(self["webpackChunktouchgfx_documentation"] = self["webpackChunktouchgfx_documentation"] || []).push([[3925],{
...
const frontMatter = {
  id: "hardware-selection-introduction",
  title: "Hardware Selection Introduction"
};
const contentTitle = void 0;
const metadata = {
  "unversionedId": "development/hardware-selection/hardware-selection-introduction",
  "id": "development/hardware-selection/hardware-selection-introduction",
  "title": "Hardware Selection Introduction",
  "description": "",
  "source": "@site/docs/development/hardware-selection/hardware-selection-introduction.mdx",
  "sourceDirName": "development/hardware-selection",
  "slug": "/development/hardware-selection/hardware-selection-introduction",
...
function MDXContent(_a) {
  ...
  return /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(MDXLayout, __spreadProps(__spreadValues(__spreadValues({}, layoutProps), props), {
    ...
    imageSource: "/img/development/hardware-selection/activities-selected-000.png",
    noShadow: true,
    width: "600",
    mdxType: "Figure"
  }, "Project activity"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/hardware-selection/components-selected-000.png",
    noShadow: true,
    width: "600",
    mdxType: "Figure"
  }, "Project component"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `There are many parameters to consider and evaluate when choosing the hardware platform for running a graphical user interface. This article attempts to address considerations about the MCU, display, external memories, UI performance, etc.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_theme_DocCardList__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
