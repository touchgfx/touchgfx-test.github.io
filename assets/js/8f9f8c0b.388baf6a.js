"use strict";
(self["webpackChunktouchgfx_documentation"] = self["webpackChunktouchgfx_documentation"] || []).push([[5687],{
...
const metadata = {
  ...
  "title": "TouchGFX on NeoChrom",
  "description": "",
  "source": "@site/docs/development/scenarios/touchgfx-on-gpu2d.mdx",
...
function MDXContent(_a) {
  ...
  return /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(MDXLayout, __spreadProps(__spreadValues(__spreadValues({}, layoutProps), props), {
    components,
    mdxType: "MDXLayout"
  }), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `This section discusses how to use TouchGFX on hardware having the NeoChrom
...
frame rate.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The NeoChrom graphics accelerator is currently only available in the
STM32U5x9 microcontrollers as found on e.g. STM32U599 Discovery Kit.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    width: "30%",
    ...
    "id": "neochrom-graphical-capabilities"
  }), `NeoChrom Graphical Capabilities`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The NeoChrom accelerator is capable of performing basic blitting (drawing images),
...
with NeoChrom.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `Compared to the DMA2D graphics accelerator NeoChrom is capable of accelerating
more graphical operations and has a richer feature set:`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("table", null, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("thead", {
    parentName: "table"
    ...
    "align": null
  }), `Yes`)))), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `With these capabilities available even more TouchGFX Widgets are
accelerated with NeoChrom:`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("table", null, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("thead", {
    parentName: "table"
  }, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("tr", {
    parentName: "thead"
  }, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("th", __spreadValues({
    ...
    "align": null
  }), `No`)))), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The operations that are not hardware accelerated are software rendered
...
extent while keeping a high performance.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h2", __spreadValues({}, {
    "id": "rendering-time-improvements-with-neochrom"
  }), `Rendering Time Improvements with NeoChrom.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The following examples illustrate the speed-up provided by NeoChrom over
...
128x128, in ARGB8888 format, and stored in the internal flash. The framebuffer is in RGB565 format.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    width: "40%",
    ...
    mdxType: "Figure"
  }, "STM32F746 running the Image project"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The figure above shows the frame rate and rendering time when runninng
...
ms. Image rendering is fast on the STM32F746.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/scenarios/touchgfx-on-gpu2d/render-time-f746-texturemapper.png",
    mdxType: "Figure"
  }, "STM32F746 running the TextureMapper project"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The figure above is the texture mapper project running on the STM32F746. The
rendering time of the TextureMapper is 4.5 ms. The TextureMapper
widget is much slower than the Image.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/scenarios/touchgfx-on-gpu2d/render-time-u599-image.png",
    mdxType: "Figure"
  }, "STM32U599 running the Image project"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `Here is the STM32U599 Discovery kit running the Image project. The
...
Image is 0.7 ms. We see that the Image widget is faster than on the STM32F746 kit.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/scenarios/touchgfx-on-gpu2d/render-time-u599-texturemapper.png",
    mdxType: "Figure"
  }, "STM32U599 running the TextureMapper project"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The render time of the TextureMapper is 1.7 ms. The TextureMapper is
also faster on STM32U599 than on the STM32F746.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h3", __spreadValues({}, {
    "id": "rendering-time-summary"
    ...
    "align": null
  }), `~3x`)))), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `We see that even with a reduced clock frequency the STM32U599 greatly
outperforms the STM32F746, especially with the TextureMapper.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `These measurements are taken with the image in internal flash and the
...
OSPI flash (8-bit bus).`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The STM32F746 Discovery kit can run with a 480x272 RGB565 framebuffer
...
applications.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h3", __spreadValues({}, {
    "id": "richer-user-interfaces"
  }), `Richer User Interfaces`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The improved rendering performance can be used to create user interfaces with
more advanced animations. For example more scaled or rotated
elements.`, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("br", {
    parentName: "p"
  }), `
...
approximately the same rendering time).`, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("br", {
    parentName: "p"
  }), `
...
texture mapper of size 485 x 485.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The following figure shows two applications running on respectively
...
elements).`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/scenarios/touchgfx-on-gpu2d/comparison-f746-u599.png",
    mdxType: "Figure"
  }, "STM32F746 (left) and STM32U599 (right) running the texture mapper based carousel project"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The STM32F746 is capable of showing three icons, one big icon, scaled up by a
factor of 1.9, and two smaller icons. The STM32U599 is capable of
showing 7 icons. The largest icon is scaled up by factor 2.7.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The rendering time of the application with 3 icons on the STM32F746 is
...
STM32U599 showing much more content in a higher resolution.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h2", __spreadValues({}, {
    "id": "creating-a-project"
  }), `Creating a project`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `CubeMX and the TouchGFX Generator supports the NeoChrom. In CubeMX the
...
configuration in CubeMX.`, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("br", {
    parentName: "p"
  }), `
...
project, make sure to enable the GPU2D Accelerator as shown below:`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    imageSource: "/img/development/scenarios/touchgfx-on-gpu2d/cubemx-u599-configuration.png",
    mdxType: "Figure"
  }, "Enabling GPU2D (NeoChrom) in CubeMX"), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `After enabling GPU2D press "Generate Code" in CubeMX. This regenerates
the target configuration code. Now open the project in the TouchGFX
Designer and generate code there also (F4).`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The Designer generates assets (images, fonts, and texts) and simulator
code, that matches the target configuration. You are now ready to
compile the code with IAR.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `If you are starting a project from the Designer there is no need to
open CubeMX unless you need to change some hardware settings.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h2", __spreadValues({}, {
    "id": "supported-ides"
  }), `Supported IDEs`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The STM32U599 TBS (version 3.0.0) is currently only supported with IAR
Workbench.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `A recent version of IAR is required (8.5x.x). Make sure that the
processor variant (STM32U599NJ for the Discovery board) is supported
by checking the General Options:`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)(_site_components_Figure__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
    ...
    "id": "framebuffer-formats"
  }), `Framebuffer Formats`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The STM32U599 discovery board supports three framebuffer formats:
RGB565, RGB888, ARGB8888. These are configurable from CubeMX.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("h2", __spreadValues({}, {
    "id": "neochrom-limitations"
  }), `NeoChrom Limitations`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `The NeoChrom graphics accelerator in STM32U599 does not support the L8
image formats (L8_RGB565, L8_RGB888, L8_ARGB8888).`, /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("br", {
    parentName: "p"
  }), `
...
be used.`), /* @__PURE__ */ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_0__/* .mdx */ .kt)("p", null, `It is therefore recommended to not use L8 images with STM32U599.`));
}
;
